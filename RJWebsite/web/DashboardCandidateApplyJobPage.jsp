<%-- 
    Document   : DashboardCandidateApplyJobPage
    Created on : Mar 13, 2022, 4:57:24 AM
    Author     : admin
--%>
        ...
        <div class="container-fluid" style="height: 850px;">
            <div class="row">
                ...
                <div class="content" >
                    ...
                    <form action="SearchCandidateApplyController?index=1&id=${job_id}" method="post">
                    ...
                    <nav aria-label="Page navigation example">
                        <ul class="pagination"  >
                            <c:if test="${index >1}">
                                <li class="page-item"><a class="page-link" href="SearchCandidateApplyController?id=${job_id}&index=${index-1}&txtSearch=${save}">Previous</a></li>
                                </c:if>
                                <c:forEach begin="1" end="${end}" var="i">
                                <li class="page-item"><a class="page-link" href="SearchCandidateApplyController?id=${job_id}&index=${i}&txtSearch=${save}">${i}</a></li>
                                </c:forEach>
                                <c:if test="${index<end}">
                                <li class="page-item"><a class="page-link" href="SearchCandidateApplyController?id=${job_id}&index=${index+1}&txtSearch=${save}">Next</a></li>
                                </c:if>
                        </ul>
                    </nav>
