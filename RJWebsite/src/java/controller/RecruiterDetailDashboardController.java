 ...
 * @author admin
 */
@WebServlet(name = "RecruiterDetailDashboardController", urlPatterns = {"/RecruiterDetailDashboardController"})
public class RecruiterDetailDashboardController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.getRequestDispatcher("RecruiterDetailDashboard.jsp").forward(request, response);
        } catch (Exception e) {
